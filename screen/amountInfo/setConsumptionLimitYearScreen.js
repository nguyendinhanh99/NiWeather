...
import { setConsumptionLimitYear } from '../../redux/slices/transactionSlice';
import AppStyle from '../../theme';

export default function SetConsumptionLimitYearScreen() {
    ...
    const saveAndGoBack = () => {
        dispatch(setConsumptionLimitYear(limitAmount)); // Lưu hạn mức vào Redux store
