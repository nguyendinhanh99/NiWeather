...
import { setConsumptionLimit } from '../../redux/slices/transactionSlice';
import AppStyle from '../../theme';

export default function SetConsumptionLimitScreen() {
    ...
    const saveAndGoBack = () => {
        dispatch(setConsumptionLimit(limitAmount)); // Lưu hạn mức vào Redux store
        console.log("Hạn mức đã lưu:", limitAmount); // In ra console
